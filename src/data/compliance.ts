  ...
  aa: {
    ...
    fields: [
      ...
      { key: "aa_auth_code", label: "Company Authentication Code", placeholder: "6-character code from Companies House", required: true },
      {
        ...
        helper: "Please email all bookkeeping documents, Excel files, bank statements, invoices/receipts and the full-year income, expenses & budget sheet to info@digiformation.uk. Tap the button to open your email app — once opened, the Continue button will unlock so you can place your order.",
      },
    ],
  },
  name: {
