          ...
          <div className="grid lg:grid-cols-[1.2fr_1fr] gap-10 lg:gap-14 items-center">
            ...
            <div className="relative hidden lg:block">
              <div className="relative rounded-2xl overflow-hidden glass shadow-elegant aspect-[4/3]">
                <img src={heroImg} alt="UK UTR number alt="Tax & Compliance" HMRC tax compliance for non-resident UK Limited Company directors" className="w-full h-full object-cover" />
