...
const priceGroups: PriceGroup[] = [
  ...
  },
  {
    ...
    tag: "04 — Banking",
    intro: "Business bank accounts and payment gateway setup for UK & US companies.",
    items: [
      { name: "UK Business Bank Account", price: "£99", link: "/banking" },
      { name: "USA Business Bank Account", price: "$149", link: "/banking" },
      { name: "Stripe / Wise Setup", price: "£79", link: "/banking" },
      { name: "Payoneer / PayPal Setup", price: "£79", link: "/banking" },
    ],
  },
];
