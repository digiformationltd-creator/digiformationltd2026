          ...
          {loading ? (
            ...
            <div className="max-w-xl mx-auto text-center glass rounded-3xl p-10">
              ...
              <p className="opacity-80 mb-6">
                ...
                <strong>{pricing.state_name}</strong> has been submitted. Our team will contact you as soon as possible to
            ...
            <div className="flex flex-col gap-8 lg:grid lg:grid-cols-[1fr_380px]">
              {/* Form fields */}
              <form id="usa-llc-checkout-form" onSubmit={handleSubmit} className="glass rounded-3xl p-6 md:p-8 space-y-5 lg:row-start-1 lg:col-start-1">
              ...
              <div className="lg:row-start-2 lg:col-start-1 space-y-3">
                <Button type="submit" form="usa-llc-checkout-form" variant="hero" size="lg" disabled={submitting} className="rounded-full w-full">
