...
const AddressRenewalReminderEmail = ({ customerName, address, expireDate, daysRemaining }: Props) => {
  ...
  return (
    <BrandEmail
      ...
      heading={headingFor(level, 'Your Registered Office Address is Expiring Soon')}
    >
...
export const template = {
  ...
  subject: (d: Record<string, any>) => `${subjectPrefix(urgencyFor(d.daysRemaining))}Registered Office Address Expiring`,
